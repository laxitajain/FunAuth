...
export default function GeneratePage() {
  ...
  const [colorResult, setColorResult] = useState<ThresholdShareResult | null>(
    null,
  );
  ...
  return (
    <div className="min-h-screen pt-28 pb-12">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div
          className={`grid gap-8 ${stats ? "lg:grid-cols-2" : "max-w-4xl mx-auto"}`}
        >
          {/* Upload Zone */}
          <div>
            <div
              ...
              {processing ? (
                ...
                <div className="text-center">
                  <img
                    src={sourceImage}
                    alt="Source"
                    className="max-h-48 mx-auto mb-4 border border-border"
                  />
            ...
            >
              ...
              <div className="space-y-3 font-mono text-xs">
                {[
                  ...
                  [
                    "Memory Usage",
                    `${(stats.memoryBytes / 1024).toFixed(1)} KB`,
                  ],
              ...
              {[
                ...
                <div key={share.name} className="cyber-panel p-4">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <button
                      onClick={() =>
                        downloadShare(share.data, share.label.toLowerCase())
                      }
                ...
                return (
                  <div key={i} className="cyber-panel p-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <button
                        onClick={() =>
                          downloadShare(share, labels[i].toLowerCase())
                        }
                        className="flex items-center gap-1 px-3 py-1 rounded-full border-2 border-border text-xs font-mono text-muted-foreground hover:text-primary hover:border-primary hover:shadow-[0_0_10px_hsl(320_100%_55%/0.3)] transition-all duration-300"
                      >
